...
<body>
	<a href="/authors/main.php"> На головну </a>
	<br>	<br>
	...
	<form name="edit-authors" method="post">
		...
		<div class="row">
			...
			<input type="text" name="name" class="coll brdr-r-5" value="<?php echo $authors['name']; ?>">
		</div>
		<div class="row">
			<label for="country" class="coll padding-lable">Країна :</label>
			<input type="text" name="country" class="coll brdr-r-5" value="<?php echo $authors['country']; ?>">
		</div>
		<div class="row">
			<label for="year_of_birth" class="coll padding-lable">Рік народження :</label>
			<input type="number" name="year_of_birth" class="coll brdr-r-5" value="<?php echo $authors['year_of_birth']; ?>">
		</div>
		<div class="row">
			<label for="genre" class="coll padding-lable">Жанри :</label>
			<input type="text" name="genre" class="coll brdr-r-5" value="<?php echo $authors['genre']; ?>">
		</div>
